 ...
 - ${i4}: ${e4}`, h2 && (l2 += encodeURI(i4) + "=" + encodeURI(e4));
        ...
        let T = { addEvent: function(e3, i3, s2, o2 = {}) {
          ...
          for (; i3.length && u(e3); ) {
            ...
            if ("this" === t4) {
              let t5;
              return l(e3) && (t5 = e3["@this"]), t5 != null ? t5 : e3;
            }
            let s2 = e3[t4];
        ...
        class a {
          ...
          run(t3, e3, i3) {
            ...
            t3 !== e3 || this.elem["forceAnimate:" + this.prop] ? (this.startTime = +new Date(), this.start = t3, this.end = e3, this.unit = i3, this.now = this.start, this.pos = 0, n2.elem = this.elem, n2.prop = this.prop, n2() && 1 === a.timers.push(n2) && h(l)) : (delete r2.curAnim[this.prop], r2.complete && 0 === Object.keys(r2.curAnim).length && r2.complete.call(this.elem));
          }
          step(t3) {
            let e3, i3;
            let s2 = +new Date(), o2 = this.options, r2 = this.elem, a2 = o2.complete, h = o2.duration, l = o2.curAnim;
              ...
              if (false !== s3 && "" !== s3) {
                let r3 = e3[o3 - 1] || { isHeader: true, plotX: e3[0].plotX, plotY: l2, series: {} }, n2 = r3.isHeader, a2 = n2 ? i3 : r3.series, h2 = a2.tt = function(t5, e4, s4) {
                  ...
                  if (!o4) {
                    ...
                    k2 || (t6.fill = M.backgroundColor, t6["stroke-width"] = (_a = M.borderWidth) != null ? _a : 1), o4 = A.label("", 0, 0, M[r4 ? "headerShape" : "shape"], void 0, void 0, M.useHTML).addClass(i3.getClassName(e4, true, r4)).attr(t6).add(T);
                  }
              ...
              let s2 = (i4) => {
                for (let s3 of i4)
                  s3.visible && (s3.dataLabels || []).forEach((i5) => {
                    var _a2, _b;
                    let o2 = i5.options || {};
                    i5.labelrank = r(o2.labelrank, s3.labelrank, (_a2 = s3.shapeArgs) == null ? void 0 : _a2.height), ((_b = o2.allowOverlap) != null ? _b : Number(o2.distance) > 0) ? (i5.oldOpacity = i5.opacity, i5.newOpacity = 1, l(i5, t3)) : e3.push(i5);
                  });
              };
      ...
      return i = [function(t, e) {
        ...
        function s(t2) {
          return function(t3) {
            ...
            var r3;
            if (t3)
              return "string" == typeof t3 ? n2(t3, e2) : "Map" === (r3 = "Object" === (r3 = Object.prototype.toString.call(t3).slice(8, -1)) && t3.constructor ? t3.constructor.name : r3) || "Set" === r3 ? Array.from(t3) : "Arguments" === r3 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r3) ? n2(t3, e2) : void 0;
          }(t2) || function() {
